...
\begin{table}
	...
	\caption{Comparison of selectKBest and baslines in Classification Task}
	\label{base1}%
	\resizebox{\linewidth}{!}{
		\begin{tabular}{c|c|c|c|c}
			\hline
			Model &\multicolumn{2}{c|}{selectKBest+SVM}&\multicolumn{2}{c}{SVM}\\
			\hline
			{components number} & {Linear kernel(\%)} & {RBF kernel(\%)}& {Linear kernel(\%)} & {RBF kernel(\%)}\\
			\cline{2-5}
			\hline
			2   & 12.45 & 16.05 & 93.28 & 93.52\\
			\hline
			5   & 23.33 & 35.80 & 93.28 & 93.52\\
			\hline
			10   & 32.88 & 48.84 & 93.28 & 93.52\\
			\hline
			20   & 57.59 & 71.85 & 93.28 & 93.52\\
			\hline
			50  & 79.86 & 85.92 & 93.28 & 93.52\\
			\hline
			100  & 87.38 & 89.85 & 93.28 & 93.52\\
			\hline
			200  & 90.69 & 91.55 & 93.28 & 93.52\\
			\hline
			500  & 92.45 & 92.75 & 93.28 & 93.52\\
			\hline
			750  & 92.77 & 92.96 & 93.28 & 93.52\\
			\hline
			1000  & 93.01 & 92.92 & 93.28 & 93.52\\
			\hline
			1200  & 92.88 & 92.84 & 93.28 & 93.52\\
			\hline
			1500  & 92.88 & 91.55 & 93.28 & 93.52\\
			\hline
			2000  & 92.98 & 91.96 & 93.28 & 93.52\\
			\hline
	\end{tabular}}
\end{table}
...
\begin{figure}
	\centering
	\subfigure[metric accuracy comparison on linear selectKBest]{
		\includegraphics[width=6.5cm]{figure/selectKBest_linear.jpg}
		%\caption{fig1}
	}
	\quad
	\subfigure[metric accuracy comparison on RBF selectKBest]{
		\includegraphics[width=6.5cm]{figure/selectKBest_rbf.jpg}
	}
	\caption{selecrKBest performance on linear kernel and RBF kernel}
	\label{Figure1}
\end{figure}

\begin{figure}
	\centering
	\subfigure[Trainset 2D scatter with selectKBest]{
		\includegraphics[width=6.5cm]{figure/X_train_scatter_2d_SelectKBest.jpg}
		%\caption{fig1}
	}
	\quad
	\subfigure[Testset 2D scatter with selectKBest]{
		\includegraphics[width=6.5cm]{figure/X_test_scatter_2d_SelectKBest.jpg}
	}
	\caption{Dataset 2D scatter with selectKBest}
	\label{Figure2}
\end{figure}
\subsubsection{Variance Threshold}
...
\begin{table}
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}{c|c|c|c|c|c}
			\hline
			Model &\multicolumn{3}{c|}{varianceThreshold+SVM}&\multicolumn{2}{c}{SVM}\\
			\hline
			{components number} & {dimension} & {Linear kernel(\%)} & {RBF kernel(\%)}& {Linear kernel(\%)} & {RBF kernel(\%)}\\
			\cline{2-5}
			\hline
			0.1   & 1883 & 92.96 & 92.24 & 93.28 & 93.52\\
			\hline
			0.2   & 1345 & 92.94 & 92.75 & 93.28 & 93.52\\
			\hline
			0.3   & 1022 & 92.87 & 93.08 & 93.28 & 93.52\\
			\hline
			0.5   & 620  & 92.94 & 92.98 & 93.28 & 93.52\\
			\hline
			0.7   & 401  & 92.63 & 92.73 & 93.28 & 93.52\\
			\hline
			0.9   & 271  & 91.88 & 92.30 & 93.28 & 93.52\\
			\hline
	\end{tabular}}
\end{table}
...
\begin{figure}
	\centering
	\subfigure[metric accuracy comparison on linear varianceThreshold]{
		\includegraphics[width=6.5cm]{figure/VarianceThreshold_linear.jpg}
		%\caption{fig1}
	}
	\quad
	\subfigure[metric accuracy comparison on RBF varianceThreshold]{
		\includegraphics[width=6.5cm]{figure/VarianceThreshold_rbf.jpg}
	}
...
\begin{table}
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}{c|c|c|c|c|c}
			\hline
			Model &\multicolumn{3}{c|}{tree-based selection+SVM}&\multicolumn{2}{c}{SVM}\\
			\hline
			{components number} & {dimension} & {Linear kernel(\%)} & {RBF kernel(\%)}& {Linear kernel(\%)} & {RBF kernel(\%)}\\
			\cline{2-5}
			\hline
			2   & 523 & 92.61 & 92.69 & 93.28 & 93.52\\
			\hline
			4   & 564 & 92.63 & 92.84 & 93.28 & 93.52\\
			\hline
			8   & 563 & 92.47 & 92.80 & 93.28 & 93.52\\
			\hline
			16   & 609  & 92.59 & 92.67 & 93.28 & 93.52\\
			\hline
			32   & 609  & 92.58 & 92.81 & 93.28 & 93.52\\
			\hline
			64   & 600  & 92.59 & 92.81 & 93.28 & 93.52\\
			\hline
	\end{tabular}}
\end{table}
...
\begin{figure}
	...
	\subfigure[metric accuracy comparison on linear Tree-based selection]{
		\includegraphics[width=6.5cm]{figure/TreeBasedSelection_linear.jpg}
		%\caption{fig1}
	}
	\quad
	\subfigure[metric accuracy comparison on RBF Tree-based selection]{
		\includegraphics[width=6.5cm]{figure/TreeBasedSelection_rbf.jpg}
	}
...
\begin{table}
	...
	\begin{tabular}{c|c|c|c|c|c|c|c|c}
		\hline
		Model &\multicolumn{6}{c|}{AutoEncoder+SVM}&\multicolumn{2}{c}{SVM}\\
		\hline
		{components} & \multicolumn{3}{c|}{Linear kernel(\%)} & \multicolumn{3}{c|}{RBF kernel(\%)} & \multicolumn{1}{c|}{Linear kernel(\%)} & \multicolumn{1}{c}{RBF kernel(\%)}\\
		\cline{2-5}
		\hline
		neighbors   & 4 & 8 & 16 & 4 & 8 & 16 & -- & -- \\
		\hline
		2   & 10.12 & 15.93 & 15.13 & 23.19 & 48.47 & 44.62 & 93.28 & 93.52\\
		\hline
		3   & 11.57 & 18.55 & 17.81 & 26.21 & 49.43 & 47.65 & 93.28 & 93.52\\
		\hline
		50   & 77.72 & 78.67 & 80.82 & 80.91 & 84.18 & 84.79 & 93.28 & 93.52\\
		\hline
		100   & 85.20 & 86.72 & 86.69 & 87.18 & 88.87 & 89.08 & 93.28 & 93.52\\
		\hline
		500   & 88.47 & 89.70 & 90.15 & 88.62 & 89.69 & 90.07 & 93.28 & 93.52\\
		\hline
		1000   & 88.74 & 89.93 & 90.48 & 88.49 & 89.58 & 90.12 & 93.28 & 93.52\\
		\hline
		2000   & 88.82 & 89.70 & 90.60 & 88.49 & 89.48 & 90.18 & 93.28 & 93.52\\
		\hline
	\end{tabular}}
\end{table}
...
\includegraphics[width=6.5cm]{figure/LLE_linear.jpg}
%\caption{fig1}
}
\quad
\subfigure[metric accuracy comparison on LLE with RBF SVM]{
\includegraphics[width=6.5cm]{figure/LLE_rbf.jpg}
}
