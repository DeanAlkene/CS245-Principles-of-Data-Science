...
\includegraphics[width=3.75cm]{Fig3.png}
%\caption{fig1}
}
\quad
\subfigure[metric Mean Rank comparison on dataset AceKG]{
\includegraphics[width=3.75cm]{Fig4.png}
}
\quad
\subfigure[metric Hits@10 comparison on dataset Freebase]{
\includegraphics[width=3.75cm]{Fig5.png}
}
\quad
\subfigure[metric Hits@10 comparison on dataset AceKG]{
\includegraphics[width=3.75cm]{Fig6.png}
}
\caption{Mean Rank and Hits@10 Comparison in Task of Link Prediction}
\label{Fig2}
\end{figure}
\end{center}
